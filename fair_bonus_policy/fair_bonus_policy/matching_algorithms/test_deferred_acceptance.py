...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul 16 14:34:52 2019
...
class TestDeferredAcceptance(unittest.TestCase):
    ...
    def test_student_without_application_da(self):
        ...
        students, universities = da.execute(students, universities)
        self.assertEqual(students[1]['status'], 1)
        self.assertEqual(students[2]['status'], 'none')
    
    def test_two_students_two_schools_da(self):
    ...
    def test_two_students_one_school_da(self):
    ...
    def test_two_students_two_seats_da(self):
        applications = {1: [{'uid': 1, 'score': 800}], 2: [{'uid': 1, 'score': 600}]}
        students = simple_setup_applications(applications)
    ...
    def test_score_over_preference_when_better_student_exists_da(self):
    ...
    def test_preference_over_score_da(self):
    ...
    def test_switched_preference_da(self):
        applications = {
        ...
        self.assertEqual(students[4]['status'], 1)
        
    def test_one_student_multiple_schools_da(self):
        applications = {
